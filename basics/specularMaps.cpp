...
int main()
{
    ...
    // Textures
	Texture plank("C:/OGL/res/texture/planks.png", GL_TEXTURE_2D, 0, GL_RGBA, GL_UNSIGNED_BYTE); 
	plank.texUnit(shaderProgram, "tex0", 0); 

    Texture plankSpec("C:/OGL/res/texture/planksSpec.png", GL_TEXTURE_2D, 1, GL_RED, GL_UNSIGNED_BYTE); 
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		et::processInput(window); // lets you esc out 
